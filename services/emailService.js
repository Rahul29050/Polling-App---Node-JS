...
const sendOTP = async (email, otp, fullname, purpose = "login") => {
  ...
  if (purpose === "password_reset") {
    ...
    subject = "Verify Your Login - Polling App OTP Verification";
         htmlContent = `
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
                <h2 style="color: #333;">Polling App Login Verification</h2>
                <p>Hi ${fullname},</p>
                <p>We received a request to log in to your Polling App account. Please use the following OTP to verify your identity:</p>
                <div style="background-color: #f4f4f4; padding: 20px; text-align: center; margin: 20px 0;">
